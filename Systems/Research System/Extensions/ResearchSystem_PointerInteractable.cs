...
public class ResearchSystem_PointerInteractable : PointerInteractable_Base
{
    [SerializeField] private ResearchObject researchObject;

    public override int PriorityValue() => PointerInteractable_References.ResearchModeInteraction;
    ...
    {
        researchObject.UnlockResearchEntry();
        return true;
    }
