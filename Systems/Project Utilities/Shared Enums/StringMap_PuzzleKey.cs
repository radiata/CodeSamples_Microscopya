public static class StringMap_PuzzleKey
{
    public static string ConvertToString(PuzzleKey puzzleKey)
    {
        switch (puzzleKey)
        {
            ...
            case PuzzleKey.RoughER_ProteinRotation:
                return "RoughER_ProteinRotation";
            case PuzzleKey.RoughER_ProteinTranslation:
                return "RoughER_ProteinTranslation";
            case PuzzleKey.SmoothER_MicrotubuleBridge_01:
                return "SmoothER_MicrotubuleBridge_01";
        }
